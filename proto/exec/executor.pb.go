...
// Deprecated: Use TriangleLeg.ProtoReflect.Descriptor instead.
...
var file_proto_executor_proto_goTypes = []any{
	(*TriangleLeg)(nil),  // 0: exec.TriangleLeg
	(*Plan)(nil),         // 1: exec.Plan
	(*ProposeReply)(nil), // 2: exec.ProposeReply
}
var file_proto_executor_proto_depIdxs = []int32{
	0, // 0: exec.Plan.legs:type_name -> exec.TriangleLeg
	1, // 1: exec.Executor.ProposePlan:input_type -> exec.Plan
	2, // 2: exec.Executor.ProposePlan:output_type -> exec.ProposeReply
